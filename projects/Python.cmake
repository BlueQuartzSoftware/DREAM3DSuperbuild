...
if(PYTHONINTERP_FOUND AND Mkdocs_FOUND)
  ...
  FILE(APPEND ${DREAM3D_SDK_FILE} "  set(PYTHON_EXECUTABLE \"${PYTHON_EXECUTABLE}\" CACHE STRING \"\")\n")
  FILE(APPEND ${DREAM3D_SDK_FILE} "  set(MKDOCS_PYTHON_EXECUTABLE \"${PYTHON_EXECUTABLE}\" CACHE STRING \"\")\n")
  FILE(APPEND ${DREAM3D_SDK_FILE} "  set(MKDOCS_EXECUTABLE \"${_mkdocs_location}\" CACHE STRING \"\")\n")
